...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="executive-group | executive">
@endsection()
...
<div class="page-header no-gutters has-tab">
    <div class="d-md-flex m-b-15 align-items-center justify-content-between notification relative" id="notification">
        <div class="media align-center justify-content-between m-b-15 w-100">
            <div class="m-l-15">
                <h4 class="m-b-0">Ban điều hành</h4>
            </div>
            @include('admin.alert')
        </div>
    </div>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Hình ảnh ( 200 x 200 )</label> 
                                            <div class="col-md-8">
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/executive.js') }}"></script>
