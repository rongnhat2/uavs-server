...
@section('menu-data')
<input type="hidden" name="" class="menu-data" value="partners-group | partners">
@endsection()
                            ...
                            <div class="card-body">
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-sm-4 col-form-label control-label">Tên đối tác</label>
                                            <div class="col-md-8">
...
@section('js')
    ...
    <script src="{{ asset('manager/assets/js/page/partners.js') }}"></script>
